...
class PublicHelpController extends Controller
{
    ...
    {
        return Cache::remember("help_navigation_{$productSlug}", 3600, function () use ($productSlug) {
    ...
    public function subsection(Subsection $subsection)
    {
        ...
        return Cache::remember("help_subsection_{$subsection->id}", 3600, function () use ($subsection) {
