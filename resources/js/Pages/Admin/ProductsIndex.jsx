          ...
          <div className="px-6 py-5 border-b border-gray-200 flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">
                {loading ? "Loading..." : `Manage your ${products.length} product${products.length !== 1 ? 's' : ''}`}
              </p>
            </div>
            <button
              type="button"
                    ...
                    <tr key={p.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <button
                            onClick={() => startEdit(p)}
                            className="inline-flex items-center px-3 py-1.5 border border-green-500 text-green-700 text-xs font-medium rounded-md hover:bg-green-50 transition-colors"
                          >
                            <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
